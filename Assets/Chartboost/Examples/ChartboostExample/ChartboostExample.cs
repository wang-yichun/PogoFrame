...
public class ChartboostExample: MonoBehaviour
{
	...
	void Start() {
		...
		*/
		...
		#if UNITY_IPHONE
		// pogoframe
		Chartboost.CreateWithAppId("578c504343150f4ec678cb84", "6fc8456e1ba6d25356865e9ab81985073711c148");
		// test id
		// Chartboost.CreateWithAppId("4f21c409cd1cb2fb7000001b", "92e2de2fd7070327bdeb54c15a5295309c6fcd2d");
		#elif UNITY_ANDROID
		// pogoframe
		Chartboost.CreateWithAppId("578c504343150f4ec678cb86", "c726dd1b602bc1837ffe29711e5e67fc9f2886d9");
		// test id
