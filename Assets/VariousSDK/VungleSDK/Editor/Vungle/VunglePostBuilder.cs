...
public class VunglePostBuilder : MonoBehaviour
{
	...
	private static void onPostProcessBuildPlayer( BuildTarget target, string pathToBuiltProject )
	{
		...
		#endif
		{
			...
			var scriptPath = Path.Combine( Application.dataPath, "VariousSDK/VungleSDK/Editor/Vungle/VunglePostProcessor.py" );
			...
			var pathToNativeCodeFiles = Path.Combine( Application.dataPath, "VariousSDK/VungleSDK/Editor/Vungle/VungleSDK" );
