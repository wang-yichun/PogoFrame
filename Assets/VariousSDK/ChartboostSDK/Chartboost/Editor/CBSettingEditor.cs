...
namespace ChartboostSDK {
	...
	public class CBSettingEditor : Editor {
        ...
        private void DoSetup() {
			...
			string libProjDestDir = FixSlashes("Assets/VariousSDK/ChartboostSDK/Plugins/Android/google-play-services_lib");
			string libProjDestDirv30 = FixSlashes ("Assets/VariousSDK/ChartboostSDK//Plugins/Android" 
				+ "/play-services-basement-" + googlePlayServicesVersion + ".aar");;
			...
			EnsureDirExists("Assets/VariousSDK/ChartboostSDK/Plugins");
			EnsureDirExists("Assets/VariousSDK/ChartboostSDK/Plugins/Android");
