...
namespace GameAnalyticsSDK.Editor
{
	...
	public class GA_SettingsInspector : UnityEditor.Editor
	{
		...
		void OnEnable()
		{
			...
			{
				ga.UpdateIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/update_orange.png", typeof(Texture2D));
			}
			
			if(ga.DeleteIcon == null)
			{
				ga.DeleteIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/delete.png", typeof(Texture2D));
			}
			
			if(ga.GameIcon == null)
			{
				ga.GameIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/game.png", typeof(Texture2D));
			}
			
			if(ga.HomeIcon == null)
			{
				ga.HomeIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/home.png", typeof(Texture2D));
			}

			if(ga.InfoIcon == null)
			{
				ga.InfoIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/info.png", typeof(Texture2D));
			}
			
			if(ga.InstrumentIcon == null)
			{
				ga.InstrumentIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/instrument.png", typeof(Texture2D));
			}
			
			if(ga.QuestionIcon == null)
			{
				ga.QuestionIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/question.png", typeof(Texture2D));
			}
			
			if(ga.UserIcon == null)
			{
				ga.UserIcon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/user.png", typeof(Texture2D));
			}
			...
			if(ga.Logo == null)
			{
				ga.Logo = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/gaLogo.png", typeof(Texture2D));
			}
		}
		...
		public override void OnInspectorGUI()
		{
			...
			if(ga.SignupButton == null)
			{
				...
				signupButton.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/default.png", typeof(Texture2D));
				signupButton.active.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/VariousSDK/GameAnalyticsSDK/Gizmos/GameAnalytics/Images/active.png", typeof(Texture2D));
