...
//                    asyncOperation = Application.LoadLevelAdditiveAsync(level);
						asyncOperation = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync (level, UnityEngine.SceneManagement.LoadSceneMode.Additive);
...
//        Application.LoadLevel(Instance._LoadingLevel);
			UnityEngine.SceneManagement.SceneManager.LoadScene (Instance._LoadingLevel);
		}
