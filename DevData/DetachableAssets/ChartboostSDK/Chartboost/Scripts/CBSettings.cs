...
namespace ChartboostSDK {
	...
	public class CBSettings : ScriptableObject
	{
	    ...
	    const string cbSettingsPath = "VariousSDK/ChartboostSDK/Chartboost/Resources";
	        ...
	        get
	        {
	            if (instance == null)
	            {
	                ...
	                if (instance == null)
	                {
	                    ...
	                    {
							AssetDatabase.CreateFolder("Assets/VariousSDK/ChartboostSDK/Chartboost", "Resources");
	                    }
