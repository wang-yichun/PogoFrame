...
//			Application.LoadLevel(1);
			UnityEngine.SceneManagement.SceneManager.LoadScene ("LowLevelDynamoDBExample");
        }

        void MidLevelScanListener()
        {
//			Application.LoadLevel(2);
			UnityEngine.SceneManagement.SceneManager.LoadScene ("TableQueryAndScanExample");
        }

        void HighLevelListener()
        {
//            Application.LoadLevel(3);
			UnityEngine.SceneManagement.SceneManager.LoadScene ("HighLevelExample");
        }
    }
}
